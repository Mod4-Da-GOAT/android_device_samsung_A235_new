...
BOARD_MKBOOTIMG_ARGS += --header_version 2 $(BOARD_BOOTIMG_HEADER_VERSION_2)
...
BOARD_ROOT_EXTRA_FOLDERS := cache carrier data_mirror efs keyrefuge linkerconfig metadata omr optics bin sys prism spu
...
TARGET_SUPPORTS_DYNAMIC_PARTITIONS := true
...
# TWRP Configuration
TW_DEVICE_VERSION := 1_Mod4DaGOAT
